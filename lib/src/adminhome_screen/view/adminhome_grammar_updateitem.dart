...
class AdminHomeGrammarUpdateItem extends GetView<AdminHomeController> {
  const AdminHomeGrammarUpdateItem(
      {super.key,
      required this.documentID,
      required this.listofoptions,
      required this.difficultyGroupValue,
      required this.languageGroupValue,
      required this.item,
      required this.answer});
  final String documentID;
  final List listofoptions;
  final String difficultyGroupValue;
  ...
  Widget build(BuildContext context) {
    controller.optionsList.clear();
    for (var i = 0; i < listofoptions.length; i++) {
      controller.optionsList.add(listofoptions[i]);
    }
